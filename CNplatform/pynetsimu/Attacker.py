...
class Attacker(object):
    ...
    def attack(self,net):
        ...
        if self.attack_method == 'Recalculated Degree':
            ...
            # net.attacker.consist_list[attack_nodeid] = int(sqrt(net.node.recovery_ability[attack_nodeid]*50) + 5)
            net.attacker.consist_list[attack_nodeid] = int(
                sqrt(net.node.recovery_ability[attack_nodeid]) * 50 * (50 + 10) / 100 + 5)
        ##############################################################
