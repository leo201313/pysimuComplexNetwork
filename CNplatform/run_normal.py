...
if __name__ == '__main__':
    ...
    while net.step < max_step:
        ...
        if (net.step % 5 == 0):
            ...
            print(sentence0)
            print('Power left:',net.attacker.power_amount,', Power consumed:',net.attacker.power_ini-net.attacker.power_amount,'\n')
        ...
        if end_flag:
            ...
            sentence0 = '- Breifly Description in Step ' + str(net.step) + '.\n' + \
                        ...
                        '. Total wasted load is: ' + str(waste_load) + '.\n'
            print(sentence0)
            print('Power left:', net.attacker.power_amount, ', Power consumed:',
                  net.attacker.power_ini - net.attacker.power_amount, '\n')
